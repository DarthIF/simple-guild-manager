...
export const login_strings = {
    invalid: {
        en: 'Invalid format for username or password.',
        pt: 'Formato invalido para o usuário ou senha.'
    },
    incorrect: {
        en: 'Invalid username or password.',
        pt: 'Usuário ou senha invalido.'
    },
    create_user_error: {
        en: 'Error during user creation.',
        pt: 'Erro durante a criação do usuário.'
    },
    create_session_error: {
        en: 'Error creating a section.',
        pt: 'Erro ao criar uma seção.'
    },
    user_already_exists: {
